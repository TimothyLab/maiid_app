...
def create_analyse(db: Session, id_user: int):
    """
...
def create_bounding_box(db: Session, id_analyse: int, x1: int, y1: int, x2: int, y2: int, class_result: str):
    """
...
def create_image(db: Session, image_path: str, md5_hash: str, id_user:int):
    """
